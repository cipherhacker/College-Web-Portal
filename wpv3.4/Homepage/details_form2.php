  ...
  include("../Login/Mysql_Config.php");
	...
	if(isset($_POST['upload-file'])){
	 ...
	 $db->query($sql);
		...
		$sql = "INSERT INTO uploads (path) VALUES ('$file')";
...
if ($conn->connect_error) {
	...
	$dbMapping = array(
	 ...
	 $sql="DELETE from unit1";
	 $conn->query($sql);
	
	foreach($namedDataArray as $key=>$value){
	  $rollno = $value[$dbMapping['col1']];
	  $DM = $value[$dbMapping['col2']];
	  $DF = $value[$dbMapping['col3']];
	  $MES = $value[$dbMapping['col4']];
	  $INS = $value[$dbMapping['col5']];
	  $PC = $value[$dbMapping['col6']];
	  $BA = $value[$dbMapping['col7']];
	  
	  
	  
	
	 
	  $sql = "INSERT INTO unit1  values('$rollno','$DM','$DF','$MES','$INS','$PC','$BA');";
...
if ($conn->connect_error) {
	...
	$dbMapping = array(
	 ...
	 $sql="DELETE from unit2";
	 $conn->query($sql);
	
	foreach($namedDataArray as $key=>$value){
	  $email = $value[$dbMapping['col1']];
	  $rollno = $value[$dbMapping['col2']];
	  $DM_2 = $value[$dbMapping['col3']];
	  $DF_2 = $value[$dbMapping['col4']];
	  $MES_2 = $value[$dbMapping['col5']];
	  $INS_2 = $value[$dbMapping['col6']];
	  $PC_2 = $value[$dbMapping['col7']];
	  $BA_2 = $value[$dbMapping['col8']];
	  
	  
	  
	
	 
	  $sql = "INSERT INTO unit2  values('$email','$rollno','$DM_2','$DF_2','$MES_2','$INS_2','$PC_2','$BA_2');";
	   if ($conn->query($sql)=== TRUE) {
		   echo "hello";
	    } else {
	      echo  "Error: " . $sql . "<br>" . $conn->error;
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Attendance Upload Sheet">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Attendance Map">
          <a class="nav-link" href="attendance_main2.php">
            <i class="fa fa-pencil-square-o"></i>
  ...
  <div class="content-wrapper">
    ...
    <br><form class="form-wrapper"  enctype="multipart/form-data" method="post"><br><br><input type="file" name="file"><br><br><br><input type="submit" name="upload-file" value="Upload Excel Sheet"><br><br><br><input type="submit" name="upload-data" value="Upload Data"><br><br>
	<input type="submit" name="upload-data2" value="Upload Data2 "></form>
	<span><?php $error;?></span>
	<br><br>
