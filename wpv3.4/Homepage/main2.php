...
session_start();
  ...
  $r=$_POST['rollno']; 
      $sql = "SELECT * FROM unit1 WHERE rollno='$r' ";
	  
	   $sql2 = "SELECT * FROM unit2 WHERE rollno='$r' ";
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
	  ...
	  <br><form class="form-wrapper" method="post"> <input type="text" name="rollno" id="rollno" placeholder="Student Roll No."> <button class="button" >Submit</button> </form><br><br>
