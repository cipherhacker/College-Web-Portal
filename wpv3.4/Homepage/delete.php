...
<input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Delete faculty</label>
<input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">Delete student</label>
 	...
 	<div class="login-form">
			...
			<div class="sign-in-htm">
				...
				<form id="signin_form" action="delf.php" method="post"> 
				<div class="group">
				...
				<div class="group">
					<input type="submit" class="button" name="create" value="delete">
				</div>
				<div class="hr"></div>
			</form>
			...
			<form id="signup_form" action="dels.php" method="post"> 
			    <div class="group">
					<label for="name" class="label">Name</label>
					<input name="name" type="text" class="input">
				</div>
				<div class="group">
					<input type="submit" class="button" name="update" value="delete">
				</div>
				<div class="hr"></div>
				<div class="foot-lnk">
				</div>
